...
int base64_encode(const void *data_buf, size_t data_len, char *result,
                  size_t out_buffer_size, int flags) {
...
int base64_decode(const char *in_buffer, size_t in_len, void *out_buffer,
                  size_t buffer_size) {
